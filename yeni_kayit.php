...
<head>
    ...
    <link rel="stylesheet" href="./AdminLTE 3 _ Advanced form elements_files/tempusdominus-bootstrap-4.min.css">
    <link rel="stylesheet" href="./AdminLTE 3 _ Advanced form elements_files/select2.min.css">
    <link rel="stylesheet" href="./AdminLTE 3 _ Advanced form elements_files/select2-bootstrap4.min.css">
    <link rel="stylesheet" href="./AdminLTE 3 _ Advanced form elements_files/bootstrap-duallistbox.min.css">
    <link rel="stylesheet" href="./AdminLTE 3 _ Advanced form elements_files/bs-stepper.min.css">
...
<div class="wrapper">
    ...
    <script src="./AdminLTE 3 _ Advanced form elements_files/jquery.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/bootstrap.bundle.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/select2.full.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/jquery.bootstrap-duallistbox.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/moment.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/jquery.inputmask.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/daterangepicker.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/bootstrap-colorpicker.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/tempusdominus-bootstrap-4.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/bootstrap-switch.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/bs-stepper.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/dropzone.min.js"></script>
    <script src="./AdminLTE 3 _ Advanced form elements_files/adminlte.min.js"></script>
    <script>
        $(function () {
