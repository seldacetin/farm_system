    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="https://adminlte.io/themes/v3/index.html#">
                    <i class="far fa-comments"></i>
                    <span class="badge badge-danger navbar-badge">3</span>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="https://adminlte.io/themes/v3/index.html#" class="dropdown-item">

                        <div class="media">
                            <img src="./AdminLTE 3 _ Dashboard_files/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                    ...
                    <a href="https://adminlte.io/themes/v3/index.html#" class="dropdown-item">
                        ...
                        <div class="media">
                            <img src="./AdminLTE 3 _ Dashboard_files/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    John Pierce
                    ...
                    <a href="https://adminlte.io/themes/v3/index.html#" class="dropdown-item">
                        ...
                        <div class="media">
                            <img src="./AdminLTE 3 _ Dashboard_files/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    Nora Silvester
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="https://adminlte.io/themes/v3/index.html#" class="dropdown-item dropdown-footer">See All Messages</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="https://adminlte.io/themes/v3/index.html#" class="dropdown-item dropdown-footer">See All Notifications</a>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-widget="fullscreen" href="https://adminlte.io/themes/v3/index.html#" role="button">
                    <i class="fas fa-expand-arrows-alt"></i>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-widget="control-sidebar" data-controlsidebar-slide="true" href="https://adminlte.io/themes/v3/index.html#" role="button">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px -8px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;"><div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                        ...
                        <div class="form-inline">
                            ...
                            </div><div class="sidebar-search-results"><div class="list-group"><a href="https://adminlte.io/themes/v3/index.html#" class="list-group-item"><div class="search-title"><strong class="text-light"></strong>N<strong class="text-light"></strong>o<strong class="text-light"></strong> <strong class="text-light"></strong>e<strong class="text-light"></strong>l<strong class="text-light"></strong>e<strong class="text-light"></strong>m<strong class="text-light"></strong>e<strong class="text-light"></strong>n<strong class="text-light"></strong>t<strong class="text-light"></strong> <strong class="text-light"></strong>f<strong class="text-light"></strong>o<strong class="text-light"></strong>u<strong class="text-light"></strong>n<strong class="text-light"></strong>d<strong class="text-light"></strong>!<strong class="text-light"></strong></div><div class="search-path"></div></a></div></div>
                        </div>
                        ...
                        <nav class="mt-2">
                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                ...
                                <li class="nav-item menu-open">
                                    <a href="https://adminlte.io/themes/v3/index.html#" class="nav-link active">
                    ...
                    </div></div></div><div class="os-scrollbar os-scrollbar-horizontal os-scrollbar-unusable os-scrollbar-auto-hidden"><div class="os-scrollbar-track"><div class="os-scrollbar-handle" style="width: 100%; transform: translate(0px, 0px);"></div></div></div><div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden"><div class="os-scrollbar-track"><div class="os-scrollbar-handle" style="height: 64.9007%; transform: translate(0px, 0px);"></div></div></div><div class="os-scrollbar-corner"></div></div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="https://adminlte.io/themes/v3/index.html#">Home</a></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="https://adminlte.io/themes/v3/index.html#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                            ...
                            <div class="card-header ui-sortable-handle" style="cursor: move;">
                                ...
                                <div class="card-tools">
                                    <ul class="nav nav-pills ml-auto">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="https://adminlte.io/themes/v3/index.html#revenue-chart" data-toggle="tab">Area</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="https://adminlte.io/themes/v3/index.html#sales-chart" data-toggle="tab">Donut</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="tab-content p-0">
                                    ...
                                    <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        <canvas id="revenue-chart-canvas" height="300" style="height: 300px; display: block; width: 878px;" width="878" class="chartjs-render-monitor"></canvas>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="direct-chat-messages">
                                    ...
                                    <div class="direct-chat-msg">
                                        ...
                                        <img class="direct-chat-img" src="./AdminLTE 3 _ Dashboard_files/user1-128x128.jpg" alt="message user image">
                                    ...
                                    <div class="direct-chat-msg right">
                                        ...
                                        <img class="direct-chat-img" src="./AdminLTE 3 _ Dashboard_files/user3-128x128.jpg" alt="message user image">
                                    ...
                                    <ul class="contacts-list">
                                        <li>
                                            <a href="https://adminlte.io/themes/v3/index.html#">
                                                <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard_files/user1-128x128.jpg" alt="User Avatar">
...
<small class="contacts-list-date float-right">2/28/2015</small>
                                        ...
                                        <li>
                                            <a href="https://adminlte.io/themes/v3/index.html#">
                                                <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard_files/user7-128x128.jpg" alt="User Avatar">
                                                <div class="contacts-list-info">
<span class="contacts-list-name">
Sarah Doe
<small class="contacts-list-date float-right">2/23/2015</small>
                                        ...
                                        <li>
                                            <a href="https://adminlte.io/themes/v3/index.html#">
                                                <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard_files/user3-128x128.jpg" alt="User Avatar">
                                                <div class="contacts-list-info">
<span class="contacts-list-name">
Nadia Jolie
<small class="contacts-list-date float-right">2/20/2015</small>
                                        ...
                                        <li>
                                            <a href="https://adminlte.io/themes/v3/index.html#">
                                                <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard_files/user5-128x128.jpg" alt="User Avatar">
                                                <div class="contacts-list-info">
<span class="contacts-list-name">
Nora S. Vans
<small class="contacts-list-date float-right">2/10/2015</small>
                                        ...
                                        <li>
                                            <a href="https://adminlte.io/themes/v3/index.html#">
                                                <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard_files/user6-128x128.jpg" alt="User Avatar">
                                                <div class="contacts-list-info">
<span class="contacts-list-name">
John K.
<small class="contacts-list-date float-right">1/27/2015</small>
                                        ...
                                        <li>
                                            <a href="https://adminlte.io/themes/v3/index.html#">
                                                <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard_files/user8-128x128.jpg" alt="User Avatar">
                                                <div class="contacts-list-info">
<span class="contacts-list-name">
Kenneth M.
                            ...
                            <div class="card-header ui-sortable-handle" style="cursor: move;">
                                ...
                                <div class="card-tools">
                                    <ul class="pagination pagination-sm">
                                        <li class="page-item"><a href="https://adminlte.io/themes/v3/index.html#" class="page-link">«</a></li>
                                        <li class="page-item"><a href="https://adminlte.io/themes/v3/index.html#" class="page-link">1</a></li>
                                        <li class="page-item"><a href="https://adminlte.io/themes/v3/index.html#" class="page-link">2</a></li>
                                        <li class="page-item"><a href="https://adminlte.io/themes/v3/index.html#" class="page-link">3</a></li>
                                        <li class="page-item"><a href="https://adminlte.io/themes/v3/index.html#" class="page-link">»</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <section class="col-lg-5 connectedSortable ui-sortable">
                        ...
                        <div class="card bg-gradient-info">
                            ...
                            <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                <canvas class="chart chartjs-render-monitor" id="line-chart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 611px;" width="611" height="250"></canvas>
                            </div>
                                ...
                                <div class="card-tools">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <a href="https://adminlte.io/themes/v3/index.html#" class="dropdown-item">Add new event</a>
                                            <a href="https://adminlte.io/themes/v3/index.html#" class="dropdown-item">Clear events</a>
                                            <div class="dropdown-divider"></div>
                                            <a href="https://adminlte.io/themes/v3/index.html#" class="dropdown-item">View calendar</a>
                                        </div>
                                    </div>
